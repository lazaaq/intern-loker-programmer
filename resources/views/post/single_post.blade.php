...
<div class="container">
	<div class="row">
		...
		<div class="col-md-8 col-md-offset-2 col-xs-12">
			...
			<img class="featured-image img-fluid" src="{{asset($post->thumbnail)}}" alt="">
			<!-- End Featured Image -->
...
<!-- Begin AlertBar
================================================== -->
<div class="alertbar p-0">
	<div class="container text-center">
		<img src="/img/logo/brand.png" alt="" width="70px"> &nbsp; Never miss a <b>story</b> from us, get weekly updates in your inbox. <a href="#" class="btn subscribe">Get Updates</a>
	</div>
</div>
<!-- End AlertBar
================================================== -->
